...
_G.packer_plugins = {
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/liambutterworth/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
