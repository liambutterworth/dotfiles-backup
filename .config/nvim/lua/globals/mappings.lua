...
vim.api.nvim_set_keymap('n', '<up>', '<cmd>resize +5<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<down>', '<cmd>resize -5<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<left>', '<cmd>vertical resize -10<cr>', { noremap = true })
vim.api.nvim_set_keymap('n', '<right>', '<cmd>vertical resize +10<cr>', { noremap = true })
