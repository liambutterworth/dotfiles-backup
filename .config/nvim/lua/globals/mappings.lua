...
api.map.normal('<c-n>', 'gt')
api.map.normal('<c-p>', 'gT')
api.map.normal('<c-w>h', ':vertical resize -10<cr>', { silent = true })
api.map.normal('<c-w>j', ':resize +5<cr>', { silent = true })
api.map.normal('<c-w>k', ':resize -5<cr>', { silent = true })
api.map.normal('<c-w>l', ':vertical resize +10<cr>', { silent = true })
